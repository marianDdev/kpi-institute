...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center">
            <img src="{{ url('/images/logo.png')  }}" class="h-8 mr-3" alt="TKI Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-green-400">TKI RESEARCH LIBRARY</span>
        </a>
...
<hr class="w-full h-2 bg-green-400 dark:bg-green">
